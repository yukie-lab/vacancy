...
\pagestyle{plain}
\title{A Vacancy Atlas of the Solar Neighbourhood: Star-by-Star, Technology-Band-Conditional Upper Bounds on Occupation from Heterogeneous Non-Detections \\[1ex] {\large Preprint, English version; a Japanese version accompanies this record; \url{doi:10.5281/zenodo.22081202}}}
...
\includegraphics[width=.9\linewidth]{figs/fig1_g3iii_dlambda.pdf}
\par\smallskip{\small Figure 1: the G3(iii) Solar-System self-test as d--\(\Lambda\). Three curves (marginalised; f\_ill = 10\(^{-2}\), the upper end; the extreme f\_ill = f\_pipe = 1) with the sensitivity boundaries (Parkes 5.24 pc, GBT 10.9 pc). Values are the frozen g3\_iii.json. Reproduce: python3 scripts/build\_paper\_figs.py}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=.9\linewidth]{figs/fig3_atlas_overview.pdf}
\par\smallskip{\small Figure 3: atlas overview (projection onto the Galactic plane, machine-generated from sim\_display\_v1). Undecidable stars in grey (thinned 1/8); stars with a T-R1 bound in the value-neutral continuous colour of the posterior at \(\pi\) = 10\(^{-2}\); EMBARK-reachable stars as outlines; the Sun as a star marker. Same colour discipline as the simulator. Reproduce: python3 scripts/build\_paper\_figs.py}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=.9\linewidth]{figs/fig4_pi_sweep.pdf}
\par\smallskip{\small Figure 4: upper-bound curves P(occupied | D, T, \(\pi\)) = expit(logit \(\pi\) + ln \(\Lambda\)). Curves use the frozen-ledger \(\Lambda\) (min/median/max of T-R1 and T-R3); the dotted line is the prior P = \(\pi\). Reproduce: python3 scripts/build\_paper\_figs.py}
\end{figure}
...
\noindent This work has made use of data from the European Space Agency (ESA) mission Gaia (\url{https://www.cosmos.esa.int/gaia}), processed by the Gaia Data Processing and Analysis Consortium (DPAC, \url{https://www.cosmos.esa.int/web/gaia/dpac/consortium}). Funding for the DPAC has been provided by national institutions, in particular the institutions participating in the Gaia Multilateral Agreement. This research has made use of the NASA Exoplanet Archive, which is operated by the California Institute of Technology, under contract with the National Aeronautics and Space Administration under the Exoplanet Exploration Program. This research has made use of the VizieR catalogue access tool, CDS, Strasbourg, France (DOI: 10.26093/cds/vizier). The Habitable Worlds Catalog is maintained by the Planetary Habitability Laboratory @ UPR Arecibo. Observation metadata from the Breakthrough Listen open data archive (seti.berkeley.edu/opendata) were used. AI systems (Anthropic Claude) were used throughout under the protocol disclosed in Appendix B.\par\smallskip

\section*{References}

\begin{itemize}\setlength{\itemsep}{1pt}
\item Bailer-Jones C. A. L. et al. 2018, AJ 156, 58.
\item Brandt T. D. 2021, ApJS 254, 42.
\item Cutri R. M. et al. 2014, VizieR On-line Data Catalog II/328.
\item Enriquez J. E. et al. 2017, ApJ 849, 104.
\item Gaia Collaboration 2016, A\&A 595, A1.
\item Gaia Collaboration 2021, A\&A 649, A1.
\item Gaia Collaboration 2023, A\&A 674, A1.
\item Gaia Collaboration, Smart R. L. et al. 2021, A\&A 649, A6.
\item Griffith R. L. et al. 2015, ApJS 217, 25.
\item Grimaldi C. 2017, Sci. Rep. 7, 46273.
\item Habitable Worlds Catalog, PHL @ UPR Arecibo (retrieved 2026-08-23).
\item Isaacson H. et al. 2017, PASP 129, 054501.
\item Jarrett T. H. et al. 2011, ApJ 735, 112.
\item Lebofsky M. et al. 2019, PASP 131, 124505.
\item Maeda Y. 2026a, Zenodo, \url{doi:10.5281/zenodo.22067884} (pre-registration (b)).
\item Maeda Y. 2026b, WAKE, Zenodo, \url{doi:10.5281/zenodo.21966305.}
\item Maeda Y. 2026c, EMBARK, Zenodo, \url{doi:10.5281/zenodo.22059576.}
\item Marocco F. et al. 2021, ApJS 253, 8.
\item NASA Exoplanet Archive, Planetary Systems Composite Parameters, \url{doi:10.26133/NEA12} (retrieved 2026-08-23).
\item Pecaut M. J., Mamajek E. E. 2013, ApJS 208, 9.
\item Price D. C. et al. 2020, AJ 159, 86.
\item Saide R. C. et al. 2023, MNRAS 522, 2393.
\item Sheikh S. Z. et al. 2019, ApJ 884, 14.
\item Suazo M. et al. 2022, MNRAS 512, 2988.
\item Suazo M. et al. 2024, MNRAS 531, 695.
\item Sullivan W. T., Brown S., Wetherill C. 1978, Science 199, 377.
\item Wlodarczyk-Sroka B. S., Garrett M. A., Siemion A. P. V. 2020, MNRAS 498, 5720.
\item Wright E. L. et al. 2010, AJ 140, 1868.
\item Wright J. T. et al. 2014a, ApJ 792, 26.
\item Wright J. T. et al. 2014b, ApJ 792, 27.
\item Wright J. T., Kanodia S., Lubar E. 2018, AJ 156, 260.
\end{itemize}
\end{document}
